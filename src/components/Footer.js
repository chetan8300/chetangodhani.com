  ...
  render() {
    return (
      <footer className="footer container">
        <div>
          <a href="https://twitter.com/@cdgodhani" target="_blank" rel="noopener noreferrer">
            Twitter
          </a>
          <a href="https://instagram.com/chetangodhaniofficial" target="_blank" rel="noopener noreferrer">
            Instagram
          </a>
        ...
        <div>
          <a href="https://github.com/chetan8300" title="Open-source on GitHub">
            <img
              src={github}
              target="_blank"
